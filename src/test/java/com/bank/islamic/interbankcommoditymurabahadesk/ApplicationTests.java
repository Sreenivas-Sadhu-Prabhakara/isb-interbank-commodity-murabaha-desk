...
class ApplicationTests {
    ...
    void serviceDomainMetadataIsServed() {
        ...
        assertThat(meta).containsEntry("serviceDomain", "Interbank Commodity Murabaha Desk");
    ...
    void controlRecordLifecycleWorks() {
        var created = rest.postForEntity(
                "http://localhost:" + port + "/v1/interbank-murabaha-deal-operating-session/initiate",
