package com.bank.islamic.interbankcommoditymurabahadesk.model;
...
/**
 * The BIAN control record for this service domain: "Interbank Murabaha Deal Operating Session".
 *
 ...
 * to its asset type (Interbank Murabaha Deal). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Interbank Murabaha Deal Operating Session";
